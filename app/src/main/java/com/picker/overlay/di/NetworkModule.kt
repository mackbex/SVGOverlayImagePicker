...
import com.picker.overlay.BuildConfig
import com.picker.overlay.data.source.remote.NetConstants
import com.picker.overlay.data.source.remote.NetConstants.CELL_TYPE_COMPANY
import com.picker.overlay.data.source.remote.NetConstants.CELL_TYPE_FIELD
import com.picker.overlay.data.source.remote.NetConstants.CELL_TYPE_HORIZONTAL_THEME
import com.picker.overlay.data.source.remote.NetConstants.CELL_TYPE_REVIEW
import com.picker.overlay.data.source.remote.service.CompanySearchService
import com.picker.overlay.domain.model.Company
import com.picker.overlay.domain.model.HorizontalTheme
import com.picker.overlay.domain.model.Items
import com.picker.overlay.domain.model.Review
import com.picker.overlay.util.RuntimeTypeAdapterFactory
